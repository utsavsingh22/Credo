<h1 align="center">Hi Peeps👋</h1>
<h3 align="center">This is a CREDO Application</h3>
...
<ul>
  <li>Create Virtual env in your project folder (pip install virtualenv)(virtualenv env)(Set-ExecutionPolicy unrestricted)</li>
  <li>Install the packages in the env (pip install flask)(.\env\Scripts\activate.ps1)</li>
  <li>Use bootstrap for frontend</li>
  <li>from flask_sqlalchemy import SQLAlchemy</li>
  <li>In terminal type python there type >>> from app import db >>> db.create_all()</li>
  <li>use db file and upload it to sqlite to check your data</li>
